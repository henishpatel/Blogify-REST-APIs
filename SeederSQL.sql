...
INSERT INTO users (user_name, email, password, about)
VALUES ('Sarah', 'sarah@example.com', 'sarahpass', 'Software engineer');

INSERT INTO users (user_name, email, password, about)
VALUES ('Michael', 'michael@example.com', 'michaelpass', 'Data scientist');

INSERT INTO users (user_name, email, password, about)
VALUES ('Emily', 'emily@example.com', 'emilypass', 'Front-end developer');

INSERT INTO users (user_name, email, password, about)
VALUES ('Daniel', 'daniel@example.com', 'danielpass', 'Game developer');

INSERT INTO users (user_name, email, password, about)
VALUES ('Sophia', 'sophia@example.com', 'sophiapass', 'Graphic designer');
...
INSERT INTO post (post_title, content, image_name, added_date, user_id, category_id)
VALUES ('Healthy Lifestyle Tips', 'Tips for a healthier life.', 'healthy-lifestyle.png', NOW(), 2, 3);
